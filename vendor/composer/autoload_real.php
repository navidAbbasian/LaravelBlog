...
class ComposerAutoloaderInit6cdf674f21d83bf5fc24f7c01afbb50a
{
    ...
    public static function getLoader()
    {
        ...
        if ($useStaticLoader) {
            $includeFiles = Composer\Autoload\ComposerStaticInit6cdf674f21d83bf5fc24f7c01afbb50a::$files;
        } else {
            $includeFiles = require __DIR__ . '/autoload_files.php';
        }
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequire6cdf674f21d83bf5fc24f7c01afbb50a($fileIdentifier, $file);
        }
 ...
 * @return void
 */
function composerRequire6cdf674f21d83bf5fc24f7c01afbb50a($fileIdentifier, $file)
{
